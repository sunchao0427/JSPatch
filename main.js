...
defineClass('FirstViewController', {
            ...
            var button2 = UIButton.alloc().initWithFrame({x:(global.SCREEN_WIDTH -300),y:300,width:200,height:44});
            button2.setBackgroundColor(UIColor.blueColor());
            var UIControlStateNormal = 0;
            button2.setTitle_forState("Test JSPatch Button",UIControlStateNormal);
